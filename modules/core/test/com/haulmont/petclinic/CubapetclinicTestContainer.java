...
public class CubapetclinicTestContainer extends TestContainer {

    public CubapetclinicTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/petclinic/app.properties",
    ...
    public static class Common extends CubapetclinicTestContainer {

        public static final CubapetclinicTestContainer.Common INSTANCE = new CubapetclinicTestContainer.Common();
